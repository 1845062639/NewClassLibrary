...
public sealed class MotorYDecisionAnchorResolutionContract
{
    public string AnchorKey { get; init; } = string.Empty;
...
public sealed class MotorYDecisionAnchorPriorityDistributionContract
{
...
public sealed class MotorYDecisionAnchorTopPriorityContract
{
    public string Priority { get; init; } = string.Empty;
    public string AnchorKey { get; init; } = string.Empty;
...
public sealed class MotorYRequiredResultPrimaryFieldDistributionContract
{
    public string PrimaryField { get; init; } = string.Empty;
    public int Count { get; init; }
    public double Share { get; init; }
    public IReadOnlyList<string> BucketKeys { get; init; } = Array.Empty<string>();
...
public sealed class MotorYLegacyFormDependencyEvidenceContract
{
...
public sealed class MotorYPrimaryFieldFocusContract
{
    ...
    public IReadOnlyList<string> CanonicalCodes { get; init; } = Array.Empty<string>();
    public IReadOnlyList<string> LegacyItemAliases { get; init; } = Array.Empty<string>();
...
public sealed class MotorYMethodAdaptationPlanContract
{
    ...
    public MotorYDecisionAnchorTopPriorityContract? DecisionAnchorTopPriorityDetail { get; init; }
    ...
    public IReadOnlyList<MotorYLegacyFormDependencyEvidenceContract> FormDependencyEvidences { get; init; } = Array.Empty<MotorYLegacyFormDependencyEvidenceContract>();
    ...
    public IReadOnlyList<MotorYObservedFieldSourceContract> ObservedAlgorithmInputFieldSources { get; init; } = Array.Empty<MotorYObservedFieldSourceContract>();
    ...
    public IReadOnlyList<MotorYDecisionAnchorResolutionContract> LegacyDecisionAnchorResolutions { get; init; } = Array.Empty<MotorYDecisionAnchorResolutionContract>();
