    ...
    private static MotorYMethodAdaptationPlanSnapshot MapAdaptationPlanSnapshot(MotorYMethodAdaptationPlanContract contract)
    {
        return new MotorYMethodAdaptationPlanSnapshot
        {
            ...
            CrossPlanDecisionAnchorPrimaryFieldFocuses = contract.CrossPlanDecisionAnchorPrimaryFieldFocuses.Select(x => new MotorYPrimaryFieldFocusSnapshot
            {
                ...
                BaselineCount = x.BaselineCount,
                BaselineShare = x.BaselineShare,
                BaselineWeightedCount = x.BaselineWeightedCount,
                BaselineWeightedShare = x.BaselineWeightedShare,
                DominantCount = x.DominantCount,
                DominantShare = x.DominantShare,
                DominantWeightedCount = x.DominantWeightedCount,
                DominantWeightedShare = x.DominantWeightedShare,
                SelectedCount = x.SelectedCount,
                SelectedShare = x.SelectedShare,
                SelectedWeightedCount = x.SelectedWeightedCount,
                SelectedWeightedShare = x.SelectedWeightedShare,
                BaselineMethodValue = x.BaselineMethodValue,
                BaselineMethodKey = x.BaselineMethodKey,
                BaselineProfileKey = x.BaselineProfileKey,
                DominantMethodValue = x.DominantMethodValue,
                DominantMethodKey = x.DominantMethodKey,
                DominantProfileKey = x.DominantProfileKey,
                SelectedMethodValue = x.SelectedMethodValue,
                SelectedMethodKey = x.SelectedMethodKey,
                SelectedProfileKey = x.SelectedProfileKey,
                CanonicalCodes = x.CanonicalCodes,
                LegacyItemAliases = x.LegacyItemAliases,
                AlgorithmFamilies = x.AlgorithmFamilies,
                VariantKinds = x.VariantKinds,
                MethodValues = x.MethodValues,
                MethodKeys = x.MethodKeys,
                ProfileKeys = x.ProfileKeys,
                LegacyMethodNames = x.LegacyMethodNames,
                SettingsMethodNames = x.SettingsMethodNames,
                LegacyBusinessCodes = x.LegacyBusinessCodes,
                LegacyAlgorithmEntries = x.LegacyAlgorithmEntries,
                LegacyEnumNames = x.LegacyEnumNames,
                LegacyFormNames = x.LegacyFormNames,
                DominantLegacyAlgorithmEntry = x.DominantLegacyAlgorithmEntry,
                SourceSections = x.SourceSections,
                SourceRanges = x.SourceRanges,
                DominantSourceSection = x.DominantSourceSection,
                DominantSourceRange = x.DominantSourceRange,
                FormNames = x.FormNames,
                FormSourceRanges = x.FormSourceRanges,
                DominantFormName = x.DominantFormName,
                DominantFormSourceRange = x.DominantFormSourceRange,
                UpstreamCanonicalCodes = x.UpstreamCanonicalCodes,
                UpstreamSummaryHints = x.UpstreamSummaryHints,
                UpstreamLegacyCodes = x.UpstreamLegacyCodes,
                AnchorKeys = x.AnchorKeys,
                SuggestedNextStepFocuses = x.SuggestedNextStepFocuses,
                SuggestedNextStepPriorities = x.SuggestedNextStepPriorities,
                Summary = x.Summary
