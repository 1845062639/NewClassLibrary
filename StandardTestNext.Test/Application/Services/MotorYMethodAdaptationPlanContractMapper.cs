...
internal static class MotorYMethodAdaptationPlanContractMapper
{
    ...
    private static global::StandardTestNext.Test.Application.Services.MotorYLegacyCodeSelectionSnapshot BuildLegacyCodeSelection(
        string canonicalCode,
        IReadOnlyList<MotorYLegacyCodeDistributionSnapshot>? legacyCodeDistributions)
        => MotorYLegacyCodeSelectionFactory.Build(
            canonicalCode,
            legacyCodeDistributions,
            "legacy code selection unavailable in builder-only route planning");
