...
public static class TestBootstrapFormattingSmokeTests
{
    ...
    private static void ShouldExposeAlgorithmFamilyPrimaryFieldFocusesInCliPlanPreview()
    {
        ...
        if (!formatted.Contains("anchor-family=GB:1:100.0 %:weighted=7:100.0 %:methods=51:method-keys=LoadB:51:profiles=delivery:legacy-methods=B法负载试验:settings-methods=B法负载试验:algo-entries=none:dominant-algo=Calc_Load_B:source-sections=none:source-ranges=none:dominant-source=gb-temperature-branch@L702-L736:forms=none:form-ranges=none:dominant-form=FrmMotor_Y_Load_B@L361:upstream=:upstream-legacy=:upstream-hints=:MotorY.LoadB:families=LoadB:blocking:summary=algorithm-family decision-anchor primary fields top 1/1: GB=1 (100pp, weighted 7/7); dominant-family=LoadB@methods=51@method-keys=LoadB:51@legacy-methods=B法负载试验@settings-methods=B法负载试验@algo-entries=none@dominant-algo=Calc_Load_B@source-sections=none@source-ranges=none@dominant-source=gb-temperature-branch@L702-L736@forms=none@form-ranges=none@dominant-form=FrmMotor_Y_Load_B@L361@upstream-legacy=none", StringComparison.Ordinal)
            || !formatted.Contains("result-family=Pcu2:1:100.0 %:weighted=7:100.0 %:methods=51:method-keys=LoadB:51:profiles=delivery:legacy-methods=B法负载试验:settings-methods=B法负载试验:algo-entries=:source-sections=:source-ranges=:forms=:form-ranges=:upstream=:upstream-legacy=:upstream-hints=:MotorY.LoadB:families=LoadB:result-fields:summary=algorithm-family required-result primary fields top 1/1: Pcu2=1 (100pp, weighted 7/7); dominant-family=LoadB@methods=51@method-keys=LoadB:51@legacy-methods=B法负载试验@settings-methods=B法负载试验@algo-entries=none@dominant-algo=none@source-sections=none@source-ranges=none@dominant-source=none@none@forms=none@form-ranges=none@dominant-form=none@none@upstream-legacy=none", StringComparison.Ordinal)
            || !formatted.Contains("anchor-variant=GB:1:100.0 %:weighted=7:100.0 %:baseline=2:22.2 %:dominant=7:77.8 %:selected=7:77.8 %:methods=51:method-keys=LoadB:51:profiles=delivery:legacy-methods=B法负载试验:settings-methods=B法负载试验:baseline-route=method=5, method-key=LoadB:5, profile=baseline:dominant-route=method=51, method-key=LoadB:51, profile=delivery:selected-route=method=51, method-key=LoadB:51, profile=delivery:upstream=:upstream-legacy=:upstream-hints=:MotorY.LoadB:variants=delivery:blocking:summary=variant-kind decision-anchor primary fields top 1/1: GB=1 (100pp, weighted 7/7); dominant-variant=delivery@methods=51@method-keys=LoadB:51@legacy-methods=B法负载试验@settings-methods=B法负载试验@algo-entries=none@dominant-algo=Calc_Load_B@source-sections=none@source-ranges=none@dominant-source=gb-temperature-branch@L702-L736@forms=none@form-ranges=none@dominant-form=FrmMotor_Y_Load_B@L361@upstream-legacy=none", StringComparison.Ordinal)
