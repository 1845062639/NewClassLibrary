...
public static class TestBootstrapFormattingSmokeTests
{
    ...
    private static void ShouldExposeWeightedCrossPlanDecisionAnchorFieldsInCliPlanPreview()
    {
        ...
        if (!formatted.Contains("anchor-cross-plan=GB:2:100.0 %:weighted=7:70.0 %:baseline=0:0.0 %:dominant=0:0.0 %:selected=0:0.0 %:methods=:method-keys=LoadB:5/NoLoad:0:profiles=:legacy-methods=B法负载试验/空载试验:settings-methods=B法负载试验/空载试验:legacy-enums=Motor_Y_Load_B/Motor_Y_NoLoad:legacy-forms=FrmMotor_Y_LoadB/FrmMotor_Y_NoLoad:algo-entries=Calc_Load_B/Calc_NoLoad:source-sections=:source-ranges=:forms=:form-ranges=:upstream=MotorY.HeatRun/MotorY.NoLoad:upstream-legacy=:upstream-hints=需要热试验提供 GB 校核/空载主链直接参与 GB 比较:MotorY.LoadB/MotorY.NoLoad:families=LoadB/NoLoad:blocking/decision-branch:summary=cross-plan decision-anchor primary fields top 1/3: GB=2 (100pp, weighted 70pp); dominant=GB@families=LoadB/NoLoad@codes=MotorY.LoadB/MotorY.NoLoad@methods=none@method-keys=LoadB:5/NoLoad:0@legacy-methods=B法负载试验/空载试验@settings-methods=B法负载试验/空载试验@legacy-enums=Motor_Y_Load_B/Motor_Y_NoLoad@legacy-forms=FrmMotor_Y_LoadB/FrmMotor_Y_NoLoad@algo-entries=Calc_Load_B/Calc_NoLoad@forms=none@form-ranges=none@dominant-source=none@none@dominant-form=none@none@baseline=0/2@baseline-weighted=0/7@dominant-share=0/2@dominant-weighted=0/7@selected-share=0/2@selected-weighted=0/7@upstream=MotorY.HeatRun/MotorY.NoLoad@upstream-legacy=none@upstream-hints=需要热试验提供 GB 校核/空载主链直接参与 GB 比较", StringComparison.Ordinal))
        {
    ...
    private static void ShouldExposeAlgorithmFamilyPrimaryFieldFocusesInCliPlanPreview()
    {
        ...
        if (!formatted.Contains("anchor-family=GB:1:100.0 %:weighted=7:100.0 %:baseline=2:22.2 %:dominant=7:77.8 %:selected=7:77.8 %:methods=51:method-keys=LoadB:51:profiles=delivery:legacy-methods=B法负载试验:settings-methods=B法负载试验:legacy-business-codes=:legacy-enums=none:legacy-forms=none:algo-entries=none:baseline-route=method=5, method-key=LoadB:5, profile=baseline:dominant-route=method=51, method-key=LoadB:51, profile=delivery:selected-route=method=51, method-key=LoadB:51, profile=delivery:upstream=:upstream-legacy=:upstream-hints=:MotorY.LoadB:families=LoadB:blocking:summary=algorithm-family decision-anchor primary fields top 1/1: GB=1 (100pp, weighted 7/7); dominant-family=LoadB@methods=51@method-keys=LoadB:51@legacy-methods=B法负载试验@settings-methods=B法负载试验@legacy-enums=none@legacy-forms=none@algo-entries=none@dominant-algo=Calc_Load_B@source-sections=none@source-ranges=none@dominant-source=gb-temperature-branch@L702-L736@forms=none@form-ranges=none@dominant-form=FrmMotor_Y_Load_B@L361@upstream-legacy=none@upstream-hints=none", StringComparison.Ordinal)
            || !formatted.Contains("result-family=Pcu2:1:100.0 %:weighted=7:100.0 %:baseline=2:22.2 %:dominant=7:77.8 %:selected=7:77.8 %:methods=51:method-keys=LoadB:51:profiles=delivery:legacy-methods=B法负载试验:settings-methods=B法负载试验:legacy-business-codes=:legacy-enums=:legacy-forms=:algo-entries=:baseline-route=method=5, method-key=LoadB:5, profile=baseline:dominant-route=method=51, method-key=LoadB:51, profile=delivery:selected-route=method=51, method-key=LoadB:51, profile=delivery:source-sections=:source-ranges=:forms=:form-ranges=:upstream=:upstream-legacy=:upstream-hints=:MotorY.LoadB:families=LoadB:result-fields:summary=algorithm-family required-result primary fields top 1/1: Pcu2=1 (100pp, weighted 7/7); dominant-family=LoadB@methods=51@method-keys=LoadB:51@legacy-methods=B法负载试验@settings-methods=B法负载试验@legacy-enums=none@legacy-forms=none@algo-entries=none@dominant-algo=none@source-sections=none@source-ranges=none@dominant-source=none@none@forms=none@form-ranges=none@dominant-form=none@none@upstream-legacy=none@upstream-hints=none", StringComparison.Ordinal)
            || !formatted.Contains("anchor-variant=GB:1:100.0 %:weighted=7:100.0 %:baseline=2:22.2 %:dominant=7:77.8 %:selected=7:77.8 %:methods=51:method-keys=LoadB:51:profiles=delivery:legacy-methods=B法负载试验:settings-methods=B法负载试验:legacy-business-codes=:legacy-enums=none:legacy-forms=none:algo-entries=none:baseline-route=method=5, method-key=LoadB:5, profile=baseline:dominant-route=method=51, method-key=LoadB:51, profile=delivery:selected-route=method=51, method-key=LoadB:51, profile=delivery:upstream=:upstream-legacy=:upstream-hints=:MotorY.LoadB:variants=delivery:blocking:summary=variant-kind decision-anchor primary fields top 1/1: GB=1 (100pp, weighted 7/7); dominant-variant=delivery@methods=51@method-keys=LoadB:51@legacy-methods=B法负载试验@settings-methods=B法负载试验@legacy-enums=none@legacy-forms=none@algo-entries=none@dominant-algo=Calc_Load_B@source-sections=none@source-ranges=none@dominant-source=gb-temperature-branch@L702-L736@forms=none@form-ranges=none@dominant-form=FrmMotor_Y_Load_B@L361@upstream-legacy=none@upstream-hints=none", StringComparison.Ordinal)
            || !formatted.Contains("result-variant=Pcu2:1:100.0 %:weighted=7:100.0 %:baseline=2:22.2 %:dominant=7:77.8 %:selected=7:77.8 %:methods=51:method-keys=LoadB:51:profiles=delivery:legacy-methods=B法负载试验:settings-methods=B法负载试验:legacy-business-codes=:legacy-enums=:legacy-forms=:algo-entries=:baseline-route=method=5, method-key=LoadB:5, profile=baseline:dominant-route=method=51, method-key=LoadB:51, profile=delivery:selected-route=method=51, method-key=LoadB:51, profile=delivery:source-sections=:source-ranges=:forms=:form-ranges=:upstream=:upstream-legacy=:upstream-hints=:MotorY.LoadB:variants=delivery:result-fields:summary=variant-kind required-result primary fields top 1/1: Pcu2=1 (100pp, weighted 7/7); dominant-variant=delivery@methods=51@method-keys=LoadB:51@legacy-methods=B法负载试验@settings-methods=B法负载试验@legacy-enums=none@legacy-forms=none@algo-entries=none@dominant-algo=none@source-sections=none@source-ranges=none@dominant-source=none@none@forms=none@form-ranges=none@dominant-form=none@none@upstream-legacy=none@upstream-hints=none", StringComparison.Ordinal)
