...
public sealed class TestBootstrap
{
    ...
    private static string FormatCrossPlanPrimaryFieldFocuses(IReadOnlyList<MotorYPrimaryFieldFocusSnapshot> focuses)
    {
        ...
        return string.Join(", ", focuses.Select(focus =>
        {
            var weightedBase = totalWeighted > 0
                ? totalWeighted
                : focus.WeightedCount;
            var methodValuePreview = focus.MethodValues.Count == 0
                ? "none"
                : FormatPreview(focus.MethodValues.Select(x => x.ToString(CultureInfo.InvariantCulture)).ToArray(), 4);
            return $"{focus.PrimaryField}:{focus.Count}:{focus.Share:P1}:weighted={focus.WeightedCount}/{weightedBase}:{focus.WeightedShare:P1}:baseline-route={FormatRoutePreview(focus.BaselineMethodValue, focus.BaselineMethodKey, focus.BaselineProfileKey)}:dominant-route={FormatRoutePreview(focus.DominantMethodValue, focus.DominantMethodKey, focus.DominantProfileKey)}:selected-route={FormatRoutePreview(focus.SelectedMethodValue, focus.SelectedMethodKey, focus.SelectedProfileKey)}:legacy-item-aliases={FormatPreview(focus.LegacyItemAliases, 6)}:methods={methodValuePreview}:method-keys={FormatPreview(focus.MethodKeys, 4)}:profiles={FormatPreview(focus.ProfileKeys, 4)}:legacy-methods={FormatPreview(focus.LegacyMethodNames, 4)}:settings-methods={FormatPreview(focus.SettingsMethodNames, 4)}:legacy-business-codes={FormatPreview(focus.LegacyBusinessCodes, 4)}:legacy-enums={FormatPreview(focus.LegacyEnumNames, 4)}:legacy-forms={FormatPreview(focus.LegacyFormNames, 4)}:algo-entries={FormatPreview(focus.LegacyAlgorithmEntries, 4)}:dominant-algo={FormatPreview(string.IsNullOrWhiteSpace(focus.DominantLegacyAlgorithmEntry) ? Array.Empty<string>() : new[] { focus.DominantLegacyAlgorithmEntry }, 1)}:source-sections={FormatPreview(focus.SourceSections, 4)}:source-ranges={FormatPreview(focus.SourceRanges, 4)}:dominant-source={FormatPreview((string.IsNullOrWhiteSpace(focus.DominantSourceSection) && string.IsNullOrWhiteSpace(focus.DominantSourceRange)) ? Array.Empty<string>() : new[] { $"{focus.DominantSourceSection}@{focus.DominantSourceRange}" }, 1)}:forms={FormatPreview(focus.FormNames, 4)}:form-ranges={FormatPreview(focus.FormSourceRanges, 4)}:dominant-form={FormatPreview((string.IsNullOrWhiteSpace(focus.DominantFormName) && string.IsNullOrWhiteSpace(focus.DominantFormSourceRange)) ? Array.Empty<string>() : new[] { $"{focus.DominantFormName}@{focus.DominantFormSourceRange}" }, 1)}:upstream={FormatPreview(focus.UpstreamCanonicalCodes, 4)}:upstream-legacy={FormatPreview(focus.UpstreamLegacyCodes, 3)}:upstream-hints={FormatPreview(focus.UpstreamSummaryHints, 2)}:{FormatPreview(focus.CanonicalCodes, 3)}:{FormatPreview(focus.AnchorKeys, 3)}:{FormatPreview(focus.SuggestedNextStepPriorities, 3)}:summary={focus.Summary}";
        }));
    }
    ...
    private static string FormatMethodAdaptationPlanSnapshot(MotorYMethodAdaptationPlanSnapshot plan)
    {
        ...
        var crossPlanAnchorPrimary = plan.CrossPlanDecisionAnchorPrimaryFieldFocuses.Count == 0
            ...
            : "anchor-cross-plan=" + string.Join("|", plan.CrossPlanDecisionAnchorPrimaryFieldFocuses.Take(3).Select(x => $"{x.PrimaryField}:{x.Count}:{x.Share:P1}:weighted={x.WeightedCount}:{x.WeightedShare:P1}:baseline={x.BaselineCount}:{x.BaselineShare:P1}:dominant={x.DominantCount}:{x.DominantShare:P1}:selected={x.SelectedCount}:{x.SelectedShare:P1}:methods={string.Join("/", x.MethodValues)}:method-keys={string.Join("/", x.MethodKeys)}:profiles={string.Join("/", x.ProfileKeys)}:legacy-methods={string.Join("/", x.LegacyMethodNames)}:settings-methods={string.Join("/", x.SettingsMethodNames)}:legacy-business-codes={string.Join("/", x.LegacyBusinessCodes)}:legacy-enums={string.Join("/", x.LegacyEnumNames)}:legacy-forms={string.Join("/", x.LegacyFormNames)}:algo-entries={string.Join("/", x.LegacyAlgorithmEntries)}:dominant-algo={x.DominantLegacyAlgorithmEntry}:source-sections={string.Join("/", x.SourceSections)}:source-ranges={string.Join("/", x.SourceRanges)}:dominant-source={x.DominantSourceSection}@{x.DominantSourceRange}:forms={string.Join("/", x.FormNames)}:form-ranges={string.Join("/", x.FormSourceRanges)}:dominant-form={x.DominantFormName}@{x.DominantFormSourceRange}:upstream={string.Join("/", x.UpstreamCanonicalCodes)}:upstream-legacy={string.Join("/", x.UpstreamLegacyCodes)}:upstream-hints={string.Join("/", x.UpstreamSummaryHints)}:{string.Join("/", x.CanonicalCodes)}:families={string.Join("/", x.AlgorithmFamilies)}:{string.Join("/", x.SuggestedNextStepPriorities)}")) + $":summary={plan.CrossPlanDecisionAnchorPrimaryFieldSummary}";
        var algorithmFamilyAnchorPrimary = plan.AlgorithmFamilyDecisionAnchorPrimaryFieldFocuses.Count == 0
            ...
            : "anchor-family=" + string.Join("|", plan.AlgorithmFamilyDecisionAnchorPrimaryFieldFocuses.Take(3).Select(x => $"{x.PrimaryField}:{x.Count}:{x.Share:P1}:weighted={x.WeightedCount}:{x.WeightedShare:P1}:baseline={x.BaselineCount}:{x.BaselineShare:P1}:dominant={x.DominantCount}:{x.DominantShare:P1}:selected={x.SelectedCount}:{x.SelectedShare:P1}:methods={string.Join("/", x.MethodValues)}:method-keys={string.Join("/", x.MethodKeys)}:profiles={string.Join("/", x.ProfileKeys)}:legacy-methods={string.Join("/", x.LegacyMethodNames)}:settings-methods={string.Join("/", x.SettingsMethodNames)}:legacy-business-codes={string.Join("/", x.LegacyBusinessCodes)}:legacy-enums={string.Join("/", x.LegacyEnumNames)}:legacy-forms={string.Join("/", x.LegacyFormNames)}:algo-entries={string.Join("/", x.LegacyAlgorithmEntries)}:dominant-algo={x.DominantLegacyAlgorithmEntry}:baseline-route={FormatRoutePreview(x.BaselineMethodValue, x.BaselineMethodKey, x.BaselineProfileKey)}:dominant-route={FormatRoutePreview(x.DominantMethodValue, x.DominantMethodKey, x.DominantProfileKey)}:selected-route={FormatRoutePreview(x.SelectedMethodValue, x.SelectedMethodKey, x.SelectedProfileKey)}:source-sections={string.Join("/", x.SourceSections)}:source-ranges={string.Join("/", x.SourceRanges)}:dominant-source={x.DominantSourceSection}@{x.DominantSourceRange}:forms={string.Join("/", x.FormNames)}:form-ranges={string.Join("/", x.FormSourceRanges)}:dominant-form={x.DominantFormName}@{x.DominantFormSourceRange}:upstream={string.Join("/", x.UpstreamCanonicalCodes)}:upstream-legacy={string.Join("/", x.UpstreamLegacyCodes)}:upstream-hints={string.Join("/", x.UpstreamSummaryHints)}:{string.Join("/", x.CanonicalCodes)}:families={string.Join("/", x.AlgorithmFamilies)}:{string.Join("/", x.SuggestedNextStepPriorities)}")) + $":summary={plan.AlgorithmFamilyDecisionAnchorPrimaryFieldSummary}";
        var variantKindAnchorPrimary = plan.VariantKindDecisionAnchorPrimaryFieldFocuses.Count == 0
            ...
            : "anchor-variant=" + string.Join("|", plan.VariantKindDecisionAnchorPrimaryFieldFocuses.Take(3).Select(x => $"{x.PrimaryField}:{x.Count}:{x.Share:P1}:weighted={x.WeightedCount}:{x.WeightedShare:P1}:baseline={x.BaselineCount}:{x.BaselineShare:P1}:dominant={x.DominantCount}:{x.DominantShare:P1}:selected={x.SelectedCount}:{x.SelectedShare:P1}:methods={string.Join("/", x.MethodValues)}:method-keys={string.Join("/", x.MethodKeys)}:profiles={string.Join("/", x.ProfileKeys)}:legacy-methods={string.Join("/", x.LegacyMethodNames)}:settings-methods={string.Join("/", x.SettingsMethodNames)}:legacy-business-codes={string.Join("/", x.LegacyBusinessCodes)}:legacy-enums={string.Join("/", x.LegacyEnumNames)}:legacy-forms={string.Join("/", x.LegacyFormNames)}:algo-entries={string.Join("/", x.LegacyAlgorithmEntries)}:dominant-algo={x.DominantLegacyAlgorithmEntry}:baseline-route={FormatRoutePreview(x.BaselineMethodValue, x.BaselineMethodKey, x.BaselineProfileKey)}:dominant-route={FormatRoutePreview(x.DominantMethodValue, x.DominantMethodKey, x.DominantProfileKey)}:selected-route={FormatRoutePreview(x.SelectedMethodValue, x.SelectedMethodKey, x.SelectedProfileKey)}:source-sections={string.Join("/", x.SourceSections)}:source-ranges={string.Join("/", x.SourceRanges)}:dominant-source={x.DominantSourceSection}@{x.DominantSourceRange}:forms={string.Join("/", x.FormNames)}:form-ranges={string.Join("/", x.FormSourceRanges)}:dominant-form={x.DominantFormName}@{x.DominantFormSourceRange}:upstream={string.Join("/", x.UpstreamCanonicalCodes)}:upstream-legacy={string.Join("/", x.UpstreamLegacyCodes)}:upstream-hints={string.Join("/", x.UpstreamSummaryHints)}:{string.Join("/", x.CanonicalCodes)}:variants={string.Join("/", x.VariantKinds)}:{string.Join("/", x.SuggestedNextStepPriorities)}")) + $":summary={plan.VariantKindDecisionAnchorPrimaryFieldSummary}";
        ...
        var crossPlanResultPrimary = plan.CrossPlanRequiredResultPrimaryFieldFocuses.Count == 0
            ...
            : "result-cross-plan=" + string.Join("|", plan.CrossPlanRequiredResultPrimaryFieldFocuses.Take(3).Select(x => $"{x.PrimaryField}:{x.Count}:{x.Share:P1}:weighted={x.WeightedCount}:{x.WeightedShare:P1}:methods={string.Join("/", x.MethodValues)}:method-keys={string.Join("/", x.MethodKeys)}:profiles={string.Join("/", x.ProfileKeys)}:legacy-methods={string.Join("/", x.LegacyMethodNames)}:settings-methods={string.Join("/", x.SettingsMethodNames)}:legacy-business-codes={string.Join("/", x.LegacyBusinessCodes)}:legacy-enums={string.Join("/", x.LegacyEnumNames)}:legacy-forms={string.Join("/", x.LegacyFormNames)}:algo-entries={string.Join("/", x.LegacyAlgorithmEntries)}:source-sections={string.Join("/", x.SourceSections)}:source-ranges={string.Join("/", x.SourceRanges)}:forms={string.Join("/", x.FormNames)}:form-ranges={string.Join("/", x.FormSourceRanges)}:upstream={string.Join("/", x.UpstreamCanonicalCodes)}:upstream-legacy={string.Join("/", x.UpstreamLegacyCodes)}:upstream-hints={string.Join("/", x.UpstreamSummaryHints)}:{string.Join("/", x.CanonicalCodes)}:families={string.Join("/", x.AlgorithmFamilies)}:{string.Join("/", x.SuggestedNextStepPriorities)}")) + $":summary={plan.CrossPlanRequiredResultPrimaryFieldSummary}";
        var algorithmFamilyResultPrimary = plan.AlgorithmFamilyRequiredResultPrimaryFieldFocuses.Count == 0
            ...
            : "result-family=" + string.Join("|", plan.AlgorithmFamilyRequiredResultPrimaryFieldFocuses.Take(3).Select(x => $"{x.PrimaryField}:{x.Count}:{x.Share:P1}:weighted={x.WeightedCount}:{x.WeightedShare:P1}:baseline={x.BaselineCount}:{x.BaselineShare:P1}:dominant={x.DominantCount}:{x.DominantShare:P1}:selected={x.SelectedCount}:{x.SelectedShare:P1}:methods={string.Join("/", x.MethodValues)}:method-keys={string.Join("/", x.MethodKeys)}:profiles={string.Join("/", x.ProfileKeys)}:legacy-methods={string.Join("/", x.LegacyMethodNames)}:settings-methods={string.Join("/", x.SettingsMethodNames)}:legacy-business-codes={string.Join("/", x.LegacyBusinessCodes)}:legacy-enums={string.Join("/", x.LegacyEnumNames)}:legacy-forms={string.Join("/", x.LegacyFormNames)}:algo-entries={string.Join("/", x.LegacyAlgorithmEntries)}:baseline-route={FormatRoutePreview(x.BaselineMethodValue, x.BaselineMethodKey, x.BaselineProfileKey)}:dominant-route={FormatRoutePreview(x.DominantMethodValue, x.DominantMethodKey, x.DominantProfileKey)}:selected-route={FormatRoutePreview(x.SelectedMethodValue, x.SelectedMethodKey, x.SelectedProfileKey)}:source-sections={string.Join("/", x.SourceSections)}:source-ranges={string.Join("/", x.SourceRanges)}:forms={string.Join("/", x.FormNames)}:form-ranges={string.Join("/", x.FormSourceRanges)}:upstream={string.Join("/", x.UpstreamCanonicalCodes)}:upstream-legacy={string.Join("/", x.UpstreamLegacyCodes)}:upstream-hints={string.Join("/", x.UpstreamSummaryHints)}:{string.Join("/", x.CanonicalCodes)}:families={string.Join("/", x.AlgorithmFamilies)}:{string.Join("/", x.SuggestedNextStepPriorities)}")) + $":summary={plan.AlgorithmFamilyRequiredResultPrimaryFieldSummary}";
        var variantKindResultPrimary = plan.VariantKindRequiredResultPrimaryFieldFocuses.Count == 0
            ...
            : "result-variant=" + string.Join("|", plan.VariantKindRequiredResultPrimaryFieldFocuses.Take(3).Select(x => $"{x.PrimaryField}:{x.Count}:{x.Share:P1}:weighted={x.WeightedCount}:{x.WeightedShare:P1}:baseline={x.BaselineCount}:{x.BaselineShare:P1}:dominant={x.DominantCount}:{x.DominantShare:P1}:selected={x.SelectedCount}:{x.SelectedShare:P1}:methods={string.Join("/", x.MethodValues)}:method-keys={string.Join("/", x.MethodKeys)}:profiles={string.Join("/", x.ProfileKeys)}:legacy-methods={string.Join("/", x.LegacyMethodNames)}:settings-methods={string.Join("/", x.SettingsMethodNames)}:legacy-business-codes={string.Join("/", x.LegacyBusinessCodes)}:legacy-enums={string.Join("/", x.LegacyEnumNames)}:legacy-forms={string.Join("/", x.LegacyFormNames)}:algo-entries={string.Join("/", x.LegacyAlgorithmEntries)}:baseline-route={FormatRoutePreview(x.BaselineMethodValue, x.BaselineMethodKey, x.BaselineProfileKey)}:dominant-route={FormatRoutePreview(x.DominantMethodValue, x.DominantMethodKey, x.DominantProfileKey)}:selected-route={FormatRoutePreview(x.SelectedMethodValue, x.SelectedMethodKey, x.SelectedProfileKey)}:source-sections={string.Join("/", x.SourceSections)}:source-ranges={string.Join("/", x.SourceRanges)}:forms={string.Join("/", x.FormNames)}:form-ranges={string.Join("/", x.FormSourceRanges)}:upstream={string.Join("/", x.UpstreamCanonicalCodes)}:upstream-legacy={string.Join("/", x.UpstreamLegacyCodes)}:upstream-hints={string.Join("/", x.UpstreamSummaryHints)}:{string.Join("/", x.CanonicalCodes)}:variants={string.Join("/", x.VariantKinds)}:{string.Join("/", x.SuggestedNextStepPriorities)}")) + $":summary={plan.VariantKindRequiredResultPrimaryFieldSummary}";
